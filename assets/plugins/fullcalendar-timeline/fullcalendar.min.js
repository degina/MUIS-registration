(function (t) {
    ...
    function n() {
        var e, n, i, r, s, o, l = Array.prototype.slice.call(arguments), a = {};
        for (e = 0; Ee.length > e; e++) {
            for (n = Ee[e], r = {}, i = null, o = null, s = 0; l.length > s; s++)o = l[s][n], t.isPlainObject(o) ? (t.extend(r, o), i = null) : null != o && (i = o);
            null != i || t.isEmptyObject(r) || (a[n] = r)
        }
        return l.unshift({}), l.push(a), t.extend.apply(t, l)
    }

    function i(e) {
        var n, i, r, s, o, l = {views: e.views || {}};
        for (n in e)if ("views" != n)if (i = e[n], t.isPlainObject(i) && !/(time|duration|interval)$/i.test(n)) {
            r = null;
            for (s in i)o = i[s], /^(month|week|day|basic|basicWeek|basicDay|agenda|agendaWeek|agendaDay|default)$/.test(s) ? (l.views[s] || (l.views[s] = {}), l.views[s][n] = o, console.log("View Option Hashes are BAD")) : (r || (r = {}), r[s] = o);
            r && (l[n] = r)
        } else l[n] = i;
        return l
    }
    ...
    function a(e, n, i) {
        var r = Math.floor(n / e.length), s = Math.floor(n - r * (e.length - 1)), o = [], l = [], a = [], d = 0;
        u(e), e.each(function (n, i) {
            var u = n === e.length - 1 ? s : r, c = t(i).outerHeight(!0);
            u > c ? (o.push(i), l.push(c), a.push(t(i).height())) : d += c
    ...
    function S(t, e) {
        var n, i;
        for (n = 0; De.length > n && (i = De[n], !E(i, t, e)); n++);
        return i
    }
    ...
    function P(n, i, r) {
        ...
        return e.isMoment(u) ? (a = e.apply(null, n), A(u, a)) : b(u) || void 0 === u ? a = e.apply(null, n) : (s = !1, o = !1, d ? xe.test(u) ? (u += "-01", n = [u], s = !0, o = !0) : (l = ke.exec(u)) && (s = !l[5], o = !0) : t.isArray(u) && (o = !0), a = i || s ? e.utc.apply(e, n) : e.apply(null, n), s ? (a._ambigTime = !0, a._ambigZone = !0) : r && (o ? a._ambigZone = !0 : d && a.zone(u))), a._fullCalendar = !0, a
    }

    function V(t, n) {
        var i, r, s = !1, o = !1, l = t.length, a = [];
        for (i = 0; l > i; i++)r = t[i], e.isMoment(r) || (r = we.moment.parseZone(r)), s = s || r._ambigTime, o = o || r._ambigZone, a.push(r);
    ...
    function I(t, e) {
        var n, i;
        return "string" == typeof e ? e : (n = e.token) ? ze[n] ? ze[n](t) : N(t, n) : e.maybe && (i = O(t, e.maybe), i.match(/[1-9]/)) ? i : ""
    }

    function W(t, e, n, i, r) {
        var s;
        return t = we.moment.parseZone(t), e = we.moment.parseZone(e), s = (t.localeData || t.lang).call(t), n = s.longDateFormat(n) || n, i = i || " - ", Z(t, e, X(n), i, r)
    }

    function Z(t, e, n, i, r) {
        var s, o, l, a, u = "", d = "", c = "", h = "", f = "";
        for (o = 0; n.length > o && (s = j(t, e, n[o]), s !== !1); o++)u += s;
        for (l = n.length - 1; l > o && (s = j(t, e, n[l]), s !== !1); l--)d = s + d;
        for (a = o; l >= a; a++)c += I(t, n[a]), h += I(e, n[a]);
        return (c || h) && (f = r ? h + i + c : c + i + h), u + f + d
    }

    function j(t, e, n) {
        var i, r;
        return "string" == typeof n ? n : (i = n.token) && (r = Ge[i.charAt(0)], r && t.isSame(e, r)) ? N(t, i) : !1
    }

    function X(t) {
        return t in _e ? _e[t] : _e[t] = U(t)
    }

    function U(t) {
        for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);)e[1] ? n.push(e[1]) : e[2] ? n.push({maybe: U(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push(e[5]);
        return n
    }
    ...
    function ie(n) {
        var i, r, s, o, l = we.dataAttrPrefix;
    ...
    function oe(t) {
        var e, n, i;
        if (t.sort(ne), e = le(t), ae(e), n = e[0]) {
            for (i = 0; n.length > i; i++)ue(n[i]);
            for (i = 0; n.length > i; i++)de(n[i], 0, 0)
        }
    }
    ...
    function le(t) {
        ...
        for (e = 0; t.length > e; e++) {
            for (n = t[e], i = 0; r.length > i && ce(n, r[i]).length; i++);
    ...
    function ae(t) {
        var e, n, i, r, s;
        for (e = 0; t.length > e; e++)for (n = t[e], i = 0; n.length > i; i++)for (r = n[i], r.forwardSegs = [], s = e + 1; t.length > s; s++)ce(r, t[s], r.forwardSegs)
    }

    function ue(t) {
        var e, n, i = t.forwardSegs, r = 0;
        if (void 0 === t.forwardPressure) {
            for (e = 0; i.length > e; e++)n = i[e], ue(n), r = Math.max(r, 1 + n.forwardPressure);
            t.forwardPressure = r
        }
    }
    ...
    function de(t, e, n) {
        ...
        if (void 0 === t.forwardCoord)for (r.length ? (r.sort(fe), de(r[0], e + 1, n), t.forwardCoord = r[0].backwardCoord) : t.forwardCoord = 1, t.backwardCoord = t.forwardCoord - (t.forwardCoord - n) / (e + 1), i = 0; r.length > i; i++)de(r[i], 0, t.forwardCoord)
    }
    ...
    function fe(t, e) {
        return e.forwardPressure - t.forwardPressure || (t.backwardCoord || 0) - (e.backwardCoord || 0) || ne(t, e)
    }
    ...
    function ge(n, i) {
        ...
        function s() {
            q = W.theme ? "ui" : "fc", n.addClass("fc"), W.isRTL ? n.addClass("fc-rtl") : n.addClass("fc-ltr"), W.theme ? n.addClass("ui-widget") : n.addClass("fc-unthemed"), $ = t("<div class='fc-view-container'/>").prependTo(n), X = new me(I, W), U = X.render(), U && n.prepend(U), a(W.defaultView), W.handleWindowResize && (J = L(f, W.windowResizeDelay), t(window).resize(J))
        }

        function o() {
            K && K.removeElement(), X.destroy(), $.remove(), n.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"), t(window).unbind("resize", J)
        }
        ...
        function u(e, n) {
            re++, K && n && K.type !== n && (X.deactivateButton(K.type), V(), K.removeElement(), K = I.view = null), !K && n && (K = oe[n], K || (K = oe[n] = I.instantiateView(n)), I.view = K, K.setElement(t("<div class='fc-view fc-" + n + "-view' />").appendTo($)), X.activateButton(n)), K && (0 > e ? te = K.computePrevDate(te) : e > 0 && (te = K.computeNextDate(te)), K.isDisplayed && !e && te.isWithin(K.intervalStart, K.intervalEnd) || l() && (V(), K.display(te), A(), E(), b(), v())), A(), re--
        }

        function d(t) {
            return l() ? (t && h(), re++, K.updateSize(!0), re--, !0) : void 0
        }
        ...
        function h() {
            Q = "number" == typeof W.contentHeight ? W.contentHeight : "number" == typeof W.height ? W.height - (U ? U.outerHeight(!0) : 0) : Math.round($.width() / Math.max(W.aspectRatio, .5))
        }

        function f(t) {
            !re && t.target === window && K.start && d(!0) && K.trigger("windowResize", ie)
        }
        ...
        function v() {
            !W.lazyFetching || ee(K.start, K.end) ? y() : p()
        }
        ...
        function E() {
            X.updateTitle(K.computeTitle())
        }

        function b() {
            var t = I.getNow();
            t.isWithin(K.intervalStart, K.intervalEnd) ? X.disableButton("today") : X.enableButton("today")
        }

        function D(t, e) {
            t = I.moment(t), e = e ? I.moment(e) : t.hasTime() ? t.clone().add(I.defaultTimedEventDuration) : t.clone().add(I.defaultAllDayEventDuration), K.select({
                start: t,
                end: e
            })
        }
        ...
        function G(t) {
            te.add(e.duration(t)), u()
        }

        function _(t, e) {
            var n, i;
            e && I.isValidViewType(e) || (e = e || "day", n = X.getViewsWithButtons().join(" "), i = n.match(RegExp("\\w+" + z(e))), i || (i = n.match(/\w+Day/)), e = i ? i[0] : "agendaDay"), te = t, a(e)
        }
        ...
        function B(t, e) {
            return void 0 === e ? W[t] : (("height" == t || "contentHeight" == t || "aspectRatio" == t) && (W[t] = e, d(!0)), void 0)
        }

        function O(t, e) {
            return W[t] ? W[t].apply(e || ie, Array.prototype.slice.call(arguments, 2)) : void 0
        }

        var I = this;
        I.initOptions(i || {});
        var W = this.options;
        I.render = r, I.destroy = o, I.refetchEvents = g, I.reportEvents = w, I.reportEventChange = S, I.rerenderEvents = p, I.changeView = a, I.select = D, I.unselect = T, I.prev = R, I.next = H, I.prevYear = x, I.nextYear = k, I.today = M, I.gotoDate = F, I.incrementDate = G, I.zoomTo = _, I.getDate = P, I.getCalendar = Y, I.getView = N, I.option = B, I.trigger = O;
        var Z = C(pe(W.lang));
        if (W.monthNames && (Z._months = W.monthNames), W.monthNamesShort && (Z._monthsShort = W.monthNamesShort), W.dayNames && (Z._weekdays = W.dayNames), W.dayNamesShort && (Z._weekdaysShort = W.dayNamesShort), null != W.firstDay) {
            var j = C(Z._week);
            j.dow = W.firstDay, Z._week = j
        }
        I.defaultAllDayEventDuration = e.duration(W.defaultAllDayEventDuration), I.defaultTimedEventDuration = e.duration(W.defaultTimedEventDuration), I.moment = function () {
            var t;
            return "local" === W.timezone ? (t = we.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === W.timezone ? we.moment.utc.apply(null, arguments) : we.moment.parseZone.apply(null, arguments), "_locale"in t ? t._locale = Z : t._lang = Z, t
        }, I.getIsAmbigTimezone = function () {
            return "local" !== W.timezone && "UTC" !== W.timezone
        }, I.rezoneDate = function (t) {
            return I.moment(t.toArray())
        }, I.getNow = function () {
            var t = W.now;
            return "function" == typeof t && (t = t()), I.moment(t)
        }, I.calculateWeekNumber = function (t) {
            var e = W.weekNumberCalculation;
            ...
            return (t.locale || t.lang).call(t, W.lang).humanize()
        }, ve.call(I, W);
        var X, U, $, q, K, Q, J, te, ee = I.isFetchNeeded, ne = I.fetchEvents, ie = n[0], re = 0, se = [], oe = {};
        te = null != W.defaultDate ? I.moment(W.defaultDate) : I.getNow(), I.getSuggestedViewHeight = function () {
            return void 0 === Q && c(), Q
        }, I.isHeightAuto = function () {
            return "auto" === W.contentHeight || "auto" === W.height
        }
    }
        ...
        function s(i) {
            ...
            return s && t.each(s.split(" "), function () {
                ...
                t.each(this.split(","), function (i, r) {
                    var l, a, u, d, c, h, g, p, m;
                    "title" == r ? (s = s.add(t("<h2>&nbsp;</h2>")), o = !1) : (l = e.getViewSpec(r), l ? (u = l.buttonTextOverride, d = l.buttonTextDefault, a = function () {
                        e.changeView(r)
                    }) : e[r] && (u = (e.overrides.buttonText || {})[r], d = n.buttonText[r], a = function () {
                        e[r]()
                    }), a && (c = n.themeButtonIcons[r], h = n.buttonIcons[r], g = u ? M(u) : c && n.theme ? "<span class='ui-icon ui-icon-" + c + "'></span>" : h && !n.theme ? "<span class='fc-icon fc-icon-" + h + "'></span>" : M(d), p = ["fc-" + r + "-button", f + "-button", f + "-state-default"], m = t('<button type="button" class="' + p.join(" ") + '">' + g + "</button>").click(function () {
                        m.hasClass(f + "-state-disabled") || (a(), (m.hasClass(f + "-state-active") || m.hasClass(f + "-state-disabled")) && m.removeClass(f + "-state-hover"))
                    }).mousedown(function () {
    ...
    function ve(n) {
        ...
        function s(e, n) {
            o(e, function (i) {
                ...
                if (n == K) {
                    if (i)for (r = 0; i.length > r; r++)s = i[r], o = l ? s : C(s, e), o && te.push.apply(te, z(o));
                    Q--, Q || U(te)
                }
            })
        }
        ...
        function o(e, i) {
            ...
            if (a)t.isFunction(a) ? (E(), a.call(I, W.clone(), Z.clone(), n.timezone, function (t) {
                ...
                if (u) {
                    ...
                    var g = t.extend({}, d || {}), p = k(e.startParam, n.startParam), m = k(e.endParam, n.endParam), v = k(e.timezoneParam, n.timezoneParam);
                    p && (g[p] = W.format()), m && (g[m] = Z.format()), n.timezone && "local" != n.timezone && (g[v] = n.timezone), E(), t.ajax(t.extend({}, Ke, e, {
                        data: g,
                        success: function (e) {
                            e = e || [];
                            var n = x(c, this, arguments);
                            t.isArray(n) && (e = n), i(e)
                        },
                        error: function () {
                            x(h, this, arguments), i()
                        },
                        complete: function () {
                            x(f, this, arguments), b()
                        }
                    }))
                } else i()
            }
        ...
        function a(e) {
            var n, i, r = we.sourceNormalizers;
        ...
        function h(t) {
            t.start = I.moment(t.start), t.end = t.end ? I.moment(t.end) : null, G(t, f(t)), U(te)
        }

        function f(e) {
            var n = {};
            return t.each(e, function (t, e) {
                g(t) && void 0 !== e && H(e) && (n[t] = e)
            }), n
        }
        ...
        function p(t, e) {
            var n, i, r, s = C(t);
            if (s) {
                for (n = z(s), i = 0; n.length > i; i++)r = n[i], r.source || (e && ($.events.push(r), r.source = $), te.push(r));
                return U(te), n
            }
            return []
        }
        ...
        function m(e) {
            ...
            for (null == e ? e = function () {
                ...
                return t._id == n
            }), te = t.grep(te, e, !0), i = 0; q.length > i; i++)t.isArray(q[i].events) && (q[i].events = t.grep(q[i].events, e, !0));
            U(te)
        }
        ...
        function E() {
            J++ || j("loading", null, !0, X())
        }

        function b() {
            --J || j("loading", null, !1, X())
        }

        function C(i, r) {
            var s, o, l, a = {};
            if (n.eventDataTransform && (i = n.eventDataTransform(i)), r && r.eventDataTransform && (i = r.eventDataTransform(i)), t.extend(a, i), r && (a.source = r), a._id = i._id || (void 0 === i.id ? "_fc" + Qe++ : i.id + ""), a.className = i.className ? "string" == typeof i.className ? i.className.split(/\s+/) : i.className : [], s = i.start || i.date, o = i.end, D(s) && (s = e.duration(s)), D(o) && (o = e.duration(o)), i.dow || e.isDuration(s) || e.isDuration(o))a.start = s ? e.duration(s) : null, a.end = o ? e.duration(o) : null, a._recurring = !0; else {
                if (s && (s = I.moment(s), !s.isValid()))return !1;
                o && (o = I.moment(o), o.isValid() || (o = null)), l = i.allDay, void 0 === l && (l = k(r ? r.allDayDefault : void 0, n.allDayDefault)), T(s, o, l, a)
            }
            return a
        }

        function T(t, e, n, i) {
            i.start = t, i.end = e, i.allDay = n, R(i), ye(i)
        }

        function R(t) {
            M(t), t.end && !t.end.isAfter(t.start) && (t.end = null), t.end || (t.end = n.forceEventDuration ? I.getDefaultEventEnd(t.allDay, t.start) : null)
        }
        ...
        function z(e, n, i) {
            ...
            if (n = n || W, i = i || Z, e)if (e._recurring) {
                ...
                for (l = n.clone().stripTime(); l.isBefore(i);)(!r || r[l.day()]) && (a = e.start, u = e.end, d = l.clone(), c = null, a && (d = d.time(a)), u && (c = l.clone().time(u)), h = t.extend({}, e), T(d, c, !a && !u, h), f.push(h)), l.add(1, "days")
            } else f.push(e);
            return f
        }
        ...
        function G(e, n, i) {
            function r(t, e) {
                return i ? w(t, e, i) : n.allDay ? y(t, e) : v(t, e)
            }

            var s, o, l, a, u, d = {};
            return n = n || {}, n.start || (n.start = e.start.clone()), void 0 === n.end && (n.end = e.end ? e.end.clone() : null), null == n.allDay && (n.allDay = e.allDay), R(n), s = {
                start: e._start.clone(),
                end: e._end ? e._end.clone() : I.getDefaultEventEnd(e._allDay, e._start),
                allDay: n.allDay
            }, R(s), o = r(n.start, s.start), n.end ? (l = r(n.end, s.end), a = l.subtract(o)) : a = null, t.each(n, function (t, e) {
                g(t) && void 0 !== e && (d[t] = e)
            }), u = _(S(e._id), null !== n.end, n.allDay, o, a, d), {dateDelta: o, durationDelta: a, undo: u}
        }
        ...
        function _(e, n, i, r, s, o) {
            ...
            return r && !r.valueOf() && (r = null), s && !s.valueOf() && (s = null), t.each(e, function (e, u) {
                ...
                d = {
                    ...
                    allDay: u._allDay
                }, n ? null === c.end && (c.end = I.getDefaultEventEnd(u._allDay, c.start)) : c.end = null, c.allDay = i, R(c), r && (c.start.add(r), c.end && c.end.add(r)), s && (c.end || (c.end = I.getDefaultEventEnd(c.allDay, c.start)), c.end.add(s)), l && !c.allDay && (r || s) && (c.start.stripZone(), c.end && c.end.stripZone()), t.extend(u, o, c), ye(u), a.push(function () {
                    t.extend(u, d), ye(u)
                })
            }), function () {
        ...
        function L(e) {
            ...
            return r && (i = "object" == typeof r ? t.extend({}, s, r) : t.extend({}, s)), i ? (e && (i.start = null, i.end = null), z(C(i), o.start, o.end)) : []
        }

        function P(t, e) {
            var i = e.source || {}, r = k(e.constraint, i.constraint, n.eventConstraint), s = k(e.overlap, i.overlap, n.eventOverlap);
            return t = F(t), Y(t, r, s, e)
        }
        ...
        function A(e, n) {
            var i, r;
            return n && (i = t.extend({}, n, e), r = z(C(i))[0]), r ? P(e, r) : (e = F(e), V(e))
        }

        function Y(e, n, i, r) {
            var s, o, l, a, u, d;
            if (e = t.extend({}, e), e.start = e.start.clone().stripZone(), e.end = e.end.clone().stripZone(), null != n) {
                for (s = N(n), o = !1, a = 0; s.length > a; a++)if (B(s[a], e)) {
                    o = !0;
                    break
                }
                if (!o)return !1
            }
            for (l = I.getPeerEvents(e, r), a = 0; l.length > a; a++)if (u = l[a], O(u, e)) {
                if (i === !1)return !1;
                if ("function" == typeof i && !i(u, r))return !1;
                if (r) {
                    if (d = k(u.overlap, (u.source || {}).overlap), d === !1)return !1;
                    if ("function" == typeof d && !d(r, u))return !1
                }
            }
            return !0
        }
        ...
        function N(t) {
            return "businessHours" === t ? L() : "object" == typeof t ? z(C(t)) : S(t)
        }
        ...
        var I = this;
        I.isFetchNeeded = i, I.fetchEvents = r, I.addEventSource = l, I.removeEventSource = u, I.updateEvent = h, I.renderEvent = p, I.removeEvents = m, I.clientEvents = S, I.mutateEvent = G, I.normalizeEventDateProps = R, I.ensureVisibleEventRange = F;
        var W, Z, j = I.trigger, X = I.getView, U = I.reportEvents, $ = {events: []}, q = [$], K = 0, Q = 0, J = 0, te = [];
        t.each((n.events ? [n.events] : []).concat(n.eventSources || []), function (t, e) {
            var n = a(e);
            n && q.push(n)
        }), I.normalizeEventRangeTimes = M, I.getBusinessHoursEvents = L, I.isEventRangeAllowed = P, I.isSelectionRangeAllowed = V, I.isExternalDropRangeAllowed = A, I._getPeerEvents = function (t, e) {
            var n, i, r = [];
            for (n = 0; te.length > n; n++)i = te[n], e && e._id === i._id || r.push(i);
            return r
        }
    }
    ...
    var we = t.fullCalendar = {version: "2.2.5"}, Se = we.views = {};
    t.fn.fullCalendar = function (e) {
        var n = Array.prototype.slice.call(arguments, 1), i = this;
        return this.each(function (r, s) {
            var o, l = t(s), a = l.data("fullCalendar");
            "string" == typeof e ? a && t.isFunction(a[e]) && (o = a[e].apply(a, n), r || (i = o), "destroy" === e && l.removeData("fullCalendar")) : a || (a = new we.calendarClass(l, e), l.data("fullCalendar", a), a.render())
        }), i
    };
    var Ee = ["header", "buttonText", "buttonIcons", "themeButtonIcons"];
    we.intersectionToSeg = m, we.applyAll = x, we.debounce = L, we.isInt = _, we.htmlEscape = M;
    var be = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], De = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"];
    we.intervalUnits = De, we.computeIntervalUnit = S;
    var Ce, Te, Re, He = {}.hasOwnProperty, xe = /^\s*\d{4}-\d\d$/, ke = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, Me = e.fn, Fe = t.extend({}, Me);
    we.moment = function () {
        return P(arguments)
    }, we.moment.utc = function () {
        var t = P(arguments, !0);
        return t.hasTime() && t.utc(), t
    }, we.moment.parseZone = function () {
        return P(arguments, !0, !0)
    }, Me.clone = function () {
        var t = Fe.clone.apply(this, arguments);
        return A(this, t), this._fullCalendar && (t._fullCalendar = !0), t
    }, Me.time = function (t) {
        if (!this._fullCalendar)return Fe.time.apply(this, arguments);
    ...
    }, Me.stripTime = function () {
        var t;
        return this._ambigTime || (t = this.toArray(), this.utc(), Te(this, t.slice(0, 3)), this._ambigTime = !0, this._ambigZone = !0), this
    }, Me.hasTime = function () {
        return !this._ambigTime
    }, Me.stripZone = function () {
        var t, e;
        return this._ambigZone || (t = this.toArray(), e = this._ambigTime, this.utc(), Te(this, t), e && (this._ambigTime = !0), this._ambigZone = !0), this
    }, Me.hasZone = function () {
        return !this._ambigZone
    }, Me.zone = function (t) {
        return null != t && (this._ambigTime = !1, this._ambigZone = !1), Fe.zone.apply(this, arguments)
    }, Me.local = function () {
        var t = this.toArray(), e = this._ambigZone;
        return Fe.local.apply(this, arguments), e && Re(this, t), this
    }, Me.format = function () {
        return this._fullCalendar && arguments[0] ? B(this, arguments[0]) : this._ambigTime ? N(this, "YYYY-MM-DD") : this._ambigZone ? N(this, "YYYY-MM-DD[T]HH:mm:ss") : Fe.format.apply(this, arguments)
    }, Me.toISOString = function () {
        return this._ambigTime ? N(this, "YYYY-MM-DD") : this._ambigZone ? N(this, "YYYY-MM-DD[T]HH:mm:ss") : Fe.toISOString.apply(this, arguments)
    }, Me.isWithin = function (t, e) {
        var n = V([this, t, e]);
        return n[0] >= n[1] && n[0] < n[2]
    }, Me.isSame = function (t, e) {
        var n;
        return this._fullCalendar ? e ? (n = V([this, t], !0), Fe.isSame.call(n[0], n[1], e)) : (t = we.moment.parseZone(t), Fe.isSame.call(this, t) && Boolean(this._ambigTime) === Boolean(t._ambigTime) && Boolean(this._ambigZone) === Boolean(t._ambigZone)) : Fe.isSame.apply(this, arguments)
    }, Me.isBefore = function (t, e) {
        var n;
        return this._fullCalendar ? (n = V([this, t]), Fe.isBefore.call(n[0], n[1], e)) : Fe.isBefore.apply(this, t, e)
    }, Me.isAfter = function (t, e) {
        var n;
        return this._fullCalendar ? (n = V([this, t]), Fe.isAfter.call(n[0], n[1], e)) : Fe.isAfter.apply(this, t, e)
    }, Ce = "_d"in e() && "updateOffset"in e, Te = Ce ? function (t, n) {
        t._d.setTime(Date.UTC.apply(Date, n)), e.updateOffset(t, !1)
    } : Y, Re = Ce ? function (t, n) {
        t._d.setTime(+new Date(n[0] || 0, n[1] || 0, n[2] || 0, n[3] || 0, n[4] || 0, n[5] || 0, n[6] || 0)), e.updateOffset(t, !1)
    } : Y;
    var ze = {
        t: function (t) {
            return N(t, "a").charAt(0)
        }, T: function (t) {
            return N(t, "A").charAt(0)
        }
    };
    ...
    we.Class = $, $.extend = function (t) {
        var e, n = this;
        return t = t || {}, R(t, "constructor") && (e = t.constructor), "function" != typeof e && (e = t.constructor = function () {
            n.apply(this, arguments)
        }), e.prototype = C(n.prototype), T(t, e.prototype), T(n, e), e
    }, $.mixin = function (t) {
        T(t.prototype || t, this.prototype)
    };
    var Le = $.extend({
        isHidden: !0,
        options: null,
        ...
        position: function () {
            var e, n, i, r, s, o = this.options, l = this.el.offsetParent().offset(), a = this.el.outerWidth(), u = this.el.outerHeight(), d = t(window), c = f(this.el);
        ...
        getCell: function (e, n, i) {
            var r, s, o, l = this.rowCoords, a = l.length, u = this.colCoords, d = u.length, c = null, h = null;
            if (i || this.inBounds(e, n)) {
                for (r = 0; a > r; r++)if (s = l[r], n >= s.top && s.bottom > n) {
                    c = r;
                    break
                }
                for (r = 0; d > r; r++)if (s = u[r], e >= s.left && s.right > e) {
                    h = r;
                    break
                }
                if (i && (null === c && (c = l[0].top > n ? 0 : a - 1), null === h && (h = u[0].left < u[1].left ? u[0].left > e ? 0 : d - 1 : e > u[0].right ? 0 : d - 1)), null !== c && null !== h)return o = this.grid.getCell(c, h), o.grid = this.grid, t.extend(o, l[c], u[h]), o
            }
            return null
        },
        computeBounds: function () {
            var t, e;
            this.containerEl && (t = this.containerEl.offset(), e = Ae.getGirths(this.containerEl), this.minX = t.left + e.left, this.maxX = t.left + this.containerEl.outerWidth() - e.right, this.minY = t.top + e.top, this.maxY = t.top + this.containerEl.outerHeight() - e.bottom)
        },
    ...
    }), Ae = we.ScrollbarDetect = {
        _isFloating: null, _isLtrRight: null, _isRtlRight: null, getGirths: function (t) {
            var e, n = {left: 0, right: 0, top: 0, bottom: 0};
            return this.ensureDetection(), this._isFloating || (e = t.width() - t[0].clientWidth, ("rtl" == t.css("direction") ? this._isRtlRight : this._isLtrRight) ? n.right = e : n.left = e, n.bottom = t.height() - t[0].clientHeight), n
        }, getIsFloating: function () {
            return this.ensureDetection(), this._isFloating
        }, getLtrSide: function () {
            return this.ensureDetection(), this._isLtrRight ? "right" : "left"
        }, getRtlSide: function () {
            return this.ensureDetection(), this._isRtlRight ? "right" : "left"
        }, ensureDetection: function () {
            null === this._isFloating && this.detect()
        }, detect: function () {
            var t, e = this.detectVGirths("ltr");
            null === e ? (this._isFloating = !0, this._isLtrRight = null, this._isRtlRight = null) : (t = this.detectVGirths("rtl"), this._isFloating = !1, this._isLtrRight = e.right > e.left, this._isRtlRight = t.right > t.left)
        }, detectVGirths: function (e) {
            var n, i, r = t('<div><div style="position:relative"/></div>').css({
                position: "absolute",
                top: -1e3,
                left: 0,
                border: 0,
                ...
                overflow: "scroll",
                direction: e
            }).appendTo("body"), s = r.children(), o = r.width(), l = null;
            return o && (n = r.offset(), i = s.offset(), l = {
                left: i.left - n.left,
                right: n.left + o - i.left
            }), r.remove(), l
        }
    };
    t(function () {
    ...
    var Ye = we.DragListener = $.extend({
        ...
        drag: function (t, e, n) {
            this.trigger("drag", t, e, n), this.dragScroll(n)
        },
        mouseup: function (t) {
        ...
        constructor: function (t, e) {
            Ye.prototype.constructor.call(this, e), this.coordMap = t
        },
        listenStart: function (t) {
            var e;
            Ye.prototype.listenStart.apply(this, arguments), this.computeCoords(), this.adjustX = 0, this.adjustY = 0, t && (e = this.getCell(t, this.options.guaranteeOrigCell), e && (this.adjustX = (e.left + e.right) / 2 - t.pageX, this.adjustY = (e.top + e.bottom) / 2 - t.pageY), this.origCell = e)
        },
        ...
        dragStart: function (t) {
            var e;
            Ye.prototype.dragStart.apply(this, arguments), e = this.getCell(t), e && this.cellOver(e)
        },
        drag: function (t, e, n) {
            var i;
            Ye.prototype.drag.apply(this, arguments), i = this.getCell(n), q(i, this.cell) || (this.cell && this.cellOut(), i && this.cellOver(i))
        },
        cellOver: function (t) {
            this.cell = t, this.trigger("cellOver", t, q(t, this.origCell), this.origCell)
        },
        cellOut: function () {
            this.cell && (this.trigger("cellOut", this.cell), this.cell = null)
        },
        listenStop: function () {
            Ye.prototype.listenStop.apply(this, arguments), this.origCell = this.cell = null, this.coordMap.clear()
        },
        scrollStop: function () {
            Ye.prototype.scrollStop.apply(this, arguments), this.computeCoords()
        },
        getCell: function (t, e) {
            return this.coordMap.getCell(t.pageX + this.adjustX, t.pageY + this.adjustY, e)
        }
    }), Be = $.extend({
        options: null,
        sourceEl: null,
        ...
        constructor: function () {
            Oe.apply(this, arguments), this.coordMap = new Pe(this), this.elsByFill = {}
        },
        ...
        computeCellRange: function (t) {
            var e;
            return this.cellDuration ? (e = this.computeCellDate(t), {
                start: e,
        ...
        removeElement: function () {
            this.unbindGlobalHandlers(), this.el && (this.el.remove(), this.el = null)
        },
        ...
        bindGlobalHandlers: function () {
            t(document).on("dragstart", this.documentDragStartProxy = t.proxy(this, "documentDragStart"))
        },
        unbindGlobalHandlers: function () {
            t(document).off("dragstart", this.documentDragStartProxy)
        },
        dayMousedown: function (t) {
            var e, n, i = this, r = this.view, s = r.opt("selectable"), a = new Ne(this.coordMap, {
        ...
        fabricateHelperEvent: function (t, e) {
            var n = e ? C(e.event) : {};
            return n.start = t.start.clone(), n.end = t.end ? t.end.clone() : null, n.allDay = null, this.view.calendar.normalizeEventDateProps(n), n.className = (n.className || []).concat("fc-helper"), e || (n.editable = !1), n
        },
        ...
        headCellHtml: function (t) {
            ...
            return '<th class="fc-day-header ' + e.widgetHeaderClass + " fc-" + be[n.day()] + '">' + M(n.format(this.colHeadFormat)) + "</th>"
        },
    ...
    Ie.mixin({
        mousedOverSeg: null, isDraggingSeg: !1, isResizingSeg: !1, segs: null, renderEvents: function (t) {
            ...
            for (e = 0; i.length > e; e++)n = i[e], K(n.event) ? r.push(n) : s.push(n);
            ...
            var n, i = this, r = this.view, s = r.calendar, a = t.el, u = t.event, d = new Be(t.el, {
                parentEl: r.el,
                ...
                dragStart: function (e) {
                    i.triggerSegMouseout(t, e), i.isDraggingSeg = !0, i.hideSeg(t), r.trigger("eventDragStart", a[0], u, e, {})
                },
                cellOver: function (e, l, a) {
                    t.cell && (a = t.cell), n = i.computeEventDrop(a, e, u), n && !s.isEventRangeAllowed(n, u) && (o(), n = null), n ? r.renderDrag(n, t) ? d.hide() : d.show() : d.show(), l && (n = null)
                },
                cellOut: function () {
                    n = null, r.destroyDrag(), d.show(), l()
                },
                dragStop: function (e) {
                    d.stop(!n, function () {
                        i.isDraggingSeg = !1, r.destroyDrag(), i.showSeg(t), r.trigger("eventDragStop", a[0], u, e, {}), n && r.reportEventDrop(u, n, this.largeUnit, a, e)
                    }), l()
                },
                listenStop: function () {
                    d.stop()
            ...
            this.view.hideEvent(t.event)
        }, showSeg: function (t) {
            this.view.showEvent(t.event)
        }, computeEventDrop: function (t, e, n) {
            var i, r, s, o = this.view.calendar, l = t.start, a = e.start;
            return l.hasTime() === a.hasTime() ? (i = this.diffDates(a, l), r = i.hours() || i.minutes() || i.seconds() || i.milliseconds(), n.allDay && r ? (s = {
                start: n.start.clone(),
                end: o.getEventEnd(n),
                allDay: !1
            }, o.normalizeEventRangeTimes(s)) : s = {
                start: n.start.clone(),
                end: n.end ? n.end.clone() : null,
                allDay: n.allDay
            }, s.start.add(i), s.end && s.end.add(i)) : s = {start: a.clone(), end: null, allDay: !a.hasTime()}, s
            ...
            var i, r, s = this, a = ie(e);
            i = new Ne(this.coordMap, {
                cellOver: function (t) {
                ...
                s.destroyDrag(), l(), r && s.view.reportExternalDrop(a, r, e, t, n)
            }), i.startDrag(n)
            ...
            function i() {
                a.destroyEventResize(), a.showSeg(t), l()
            }

            var r, s, a = this, u = this.view, d = u.calendar, c = t.el, h = t.event, f = d.getEventEnd(h);
            r = new Ne(this.coordMap, {
                distance: 5,
                scroll: u.opt("dragScroll"),
                guaranteeOrigCell: !0,
                dragStart: function (e) {
                    a.triggerSegMouseout(t, e), a.isResizingSeg = !0, u.trigger("eventResizeStart", c[0], h, e, {})
                },
                cellOver: function (e, i, r) {
                    s = n ? a.computeEventStartResize(r, e, h) : a.computeEventEndResize(r, e, h), s && (d.isEventRangeAllowed(s, h) ? s.start.isSame(h.start) && s.end.isSame(f) && (s = null) : (o(), s = null)), s && (a.renderEventResize(s, t), a.hideSeg(t))
                },
                cellOut: function () {
                    s = null, i()
                },
                dragStop: function (t) {
                    a.isResizingSeg = !1, i(), u.trigger("eventResizeStop", c[0], h, t, {}), s && u.reportEventResize(h, s, this.largeUnit, c, t)
                }
            }), r.mousedown(e)
            ...
            var r, s, o, l = this.view.calendar, a = this.diffDates(n[t], e[t]);
            return r = {
                start: i.start.clone(),
                end: l.getEventEnd(i)
            }, (a.hours() || a.minutes() || a.seconds() || a.milliseconds()) && (r.allDay = !1, l.normalizeEventRangeTimes(r)), r[t].add(a), r.start.isBefore(r.end) || (s = i.allDay ? l.defaultAllDayEventDuration : l.defaultTimedEventDuration, o = s > this.cellDuration ? this.cellDuration : s, "start" == t ? r.start = r.end.clone().subtract(o) : r.end = r.start.clone().add(o)), r
        }, diffDates: function (t, e) {
            return this.largeUnit ? w(t, e, this.largeUnit) : v(t, e)
        }, renderEventResize: function () {
        }, destroyEventResize: function () {
        }, getEventTimeText: function (t) {
            return this.displayEventTime && t.start.hasTime() ? this.formatEventRange(t, this.eventTimeFormat) : void 0
        }, formatEventRange: function (t, e) {
            return t.end && this.displayEventEnd ? this.view.formatRange(t, e) : t.start.format(e)
        ...
        }, getEventSkinCssStr: function (e) {
            var n = this.getEventSkinCss(e), i = [];
            ...
            return t.each(i, function (t, e) {
                e.length && r.push.apply(r, Q(e[0]) ? n.eventsToInverseRanges(e) : n.eventsToNormalRanges(e))
            }), r
            ...
            for (o.sort(ee), e = 0; o.length > e; e++)n = o[e], n.start > u && l.push({
                event: a,
                start: u,
                end: n.start
            }), u = n.end;
    ...
    }), we.compareSegs = ne, we.dataAttrPrefix = "";
    var We = Ie.extend({
        numbersVisible: !1,
        ...
        helperEls: null,
        constructor: function () {
            Ie.apply(this, arguments), this.cellDuration = e.duration(1, "day")
        },
        ...
        computeRowCoords: function () {
            var t = Ie.prototype.computeRowCoords.call(this);
    ...
    We.mixin({
        rowStructs: null, destroyEvents: function () {
            this.destroySegPopover(), Ie.prototype.destroyEvents.apply(this, arguments)
        }, getEventSegs: function () {
            return Ie.prototype.getEventSegs.call(this).concat(this.popoverSegs || [])
        }, renderBgSegs: function (e) {
            var n = t.grep(e, function (t) {
                return t.event.allDay
            });
            return Ie.prototype.renderBgSegs.call(this, n)
            ...
            var n, i, r = this.view, s = t.event, o = r.isEventDraggable(s), l = !e && t.isStart && r.isEventResizableFromStart(s), a = !e && t.isEnd && r.isEventResizableFromEnd(s), u = this.getSegClasses(t, o, l || a), d = this.getEventSkinCssStr(s), c = "";
            ...
            var e, n, i, r = [];
            for (t.sort(ne), e = 0; t.length > e; e++) {
                for (n = t[e], i = 0; r.length > i && re(n, r[i]); i++);
                n.level = i, (r[i] || (r[i] = [])).push(n)
            }
            for (i = 0; r.length > i; i++)r[i].sort(se);
            return r
        ...
        segPopover: null, popoverSegs: null, destroySegPopover: function () {
            ...
            function i(i) {
                for (; i > D;)r = S.getCell(e, D), d = S.getCellSegs(r, n), d.length && (f = o[n - 1][D], w = S.renderMoreLink(r, d), y = t("<div/>").append(w), f.append(y), b.push(y[0])), D++
            }

            var r, s, o, l, a, u, d, c, h, f, g, p, m, v, y, w, S = this, E = this.rowStructs[e], b = [], D = 0;
            if (n && E.segLevels.length > n) {
                ...
                i(this.colCnt), E.moreEls = t(b), E.limitedEls = t(l)
            }
            ...
            }, this.isRTL ? r.right = l.offset().left + l.outerWidth() + 1 : r.left = l.offset().left - 1, this.segPopover = new Le(r), this.segPopover.show()
        }, renderSegPopoverContent: function (e, n) {
            var i, r = this.view, s = r.opt("theme"), o = e.start.format(r.opt("dayPopoverFormat")), l = t('<div class="fc-header ' + r.widgetHeaderClass + '">' + '<span class="fc-close ' + (s ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span>' + '<span class="fc-title">' + M(o) + "</span>" + '<div class="fc-clear"/>' + "</div>" + '<div class="fc-body ' + r.widgetContentClass + '">' + '<div class="fc-event-container"></div>' + "</div>"), a = l.find(".fc-event-container");
    ...
    var Ze = Ie.extend({
        ...
        constructor: function () {
            Ie.apply(this, arguments), this.processOptions()
        },
        renderDates: function () {
            this.el.html(this.renderHtml()), this.dayEls = this.el.find(".fc-day"), this.slatEls = this.el.find(".fc-slats tr"), this.computeSlatTops()
        },
        renderBusinessHours: function () {
    ...
    Ze.mixin({
        eventSkeletonEl: null, renderFgSegs: function (e) {
            ...
            for (n = this.groupSegCols(e), this.computeSegVerticals(e), s = 0; n.length > s; s++) {
                for (o = n[s], oe(o), l = t('<div class="fc-event-container"/>'), i = 0; o.length > i; i++)r = o[i], r.el.css(this.generateSegPositionCss(r)), 30 > r.bottom - r.top && r.el.addClass("fc-short"), l.append(r.el);
    ...
    var je = we.View = $.extend({
        ...
        constructor: function (t, n, i) {
            this.calendar = t, this.options = n, this.explicitDuration = i, this.nextDayThreshold = e.duration(this.opt("nextDayThreshold")), this.initThemingProps(), this.initHiddenDays(), this.initialize()
        },
        initialize: function () {
        },
        opt: function (t) {
        ...
        computeRange: function (t) {
            var n, i, r = e.duration(this.explicitDuration), s = S(r), o = t.clone().startOf(s), l = o.clone().add(r);
            return E("days", r) ? (o.stripTime(), l.stripTime()) : (o.hasTime() || (o = this.calendar.rezoneDate(o)), l.hasTime() || (l = this.calendar.rezoneDate(l))), n = o.clone(), n = this.skipHiddenDays(n), i = l.clone(), i = this.skipHiddenDays(i, -1, !0), {
                intervalDuration: r,
                intervalUnit: s,
                intervalStart: o,
                intervalEnd: l,
        ...
        formatRange: function (t, e, n) {
            var i = t.end;
            return i.hasTime() || (i = i.clone().subtract(1)), W(t.start, i, e, n, this.opt("isRTL"))
        },
        formatWeekNumber: function (t, e) {
            var n = this.opt("weekNumberTitle"), i = this.calendar.calculateWeekNumber(t);
            return e = e || "", this.opt("isRTL") ? i + e + n : n + e + i
        },
        getWeekNumberFormat: function (t) {
            var e = this.opt("weekNumberTitle");
            return t = t || "", this.opt("isRTL") ? "w[" + t + e + "]" : "[" + e + t + "]w"
        },
        setElement: function (t) {
            this.el = t, this.bindGlobalHandlers()
        },
        removeElement: function () {
            this.clear(), this.isSkeletonRendered && (this.destroySkeleton(), this.isSkeletonRendered = !1), this.unbindGlobalHandlers(), this.el.remove(), this.el = null
        },
        display: function (t) {
            var e;
            this.isDisplayed && (e = this.queryScrollState()), this.clear(), this.setDate(t), this.render(), this.updateSize(), this.renderBusinessHours(), this.isDisplayed = !0, e = this.computeInitialScrollState(e), this.forceScrollState(e), this.triggerRender()
        },
        clear: function () {
        ...
        bindGlobalHandlers: function () {
            t(document).on("mousedown", this.documentMousedownProxy = t.proxy(this, "documentMousedown"))
        },
        unbindGlobalHandlers: function () {
        ...
        updateSize: function (t) {
            var e;
            t && (e = this.queryScrollState()), this.updateHeight(), this.updateWidth(), t && this.setScrollState(e)
        },
        ...
        computeInitialScrollState: function () {
            return 0
        },
        queryScrollState: function () {
            return this.scrollerEl ? this.scrollerEl.scrollTop() : void 0
        },
        setScrollState: function (t) {
            return this.scrollerEl ? this.scrollerEl.scrollTop(t) : void 0
        },
        forceScrollState: function (t) {
            var e = this;
            this.setScrollState(t), setTimeout(function () {
                e.setScrollState(t)
            }, 0)
        },
        displayEvents: function (t) {
            var e = this.queryScrollState();
            this.clearEvents(), this.renderEvents(t), this.isEventsRendered = !0, this.setScrollState(e), this.triggerEventRender()
        },
        ...
        documentMousedown: function (e) {
            var n;
            this.isSelected && this.opt("unselectAuto") && p(e) && (n = this.opt("unselectCancel"), n && t(e.target).closest(n).length || this.unselect(e))
        },
        ...
        initOptions: function (t) {
            var e, r, s, o;
            t = i(t), e = t.lang, r = Ue[e], r || (e = Xe.defaults.lang, r = Ue[e] || {}), s = k(t.isRTL, r.isRTL, Xe.defaults.isRTL), o = s ? Xe.rtlDefaults : {}, this.dirDefaults = o, this.langDefaults = r, this.overrides = t, this.options = n(Xe.defaults, o, r, t), this.viewSpecCache = {}
        },
        ...
        buildViewSpec: function (t) {
            for (var i, r, s, o, l, a, u = this.overrides.views || {}, d = [], c = [], h = t; h && !i;)r = Se[h] || {}, s = u[h] || {}, o = o || s.duration || r.duration, h = s.type || r.type, "function" == typeof r ? (i = r, d.unshift(i.defaults || {})) : d.unshift(r), c.unshift(s);
            return i ? (a = {"class": i}, o && (o = e.duration(o), +o || (o = null)), o && (a.duration = o, l = S(o), 1 === E(l, o) && (a.singleUnit = l, c.unshift(u[l] || {}))), a.defaults = n.apply(null, d), a.overrides = n.apply(null, c), this.buildViewSpecOptions(a), this.buildViewSpecButtonText(a, t), a) : void 0
        },
        buildViewSpecOptions: function (t) {
            t.options = n(Xe.defaults, t.defaults, this.dirDefaults, this.langDefaults, this.overrides, t.overrides)
        },
        buildViewSpecButtonText: function (t, e) {
            ...
            t.buttonTextOverride = t.overrides.buttonText || n(this.overrides), t.buttonTextDefault = n(this.langDefaults) || n(this.dirDefaults) || t.defaults.buttonText || n(Xe.defaults) || (t.duration ? this.humanizeDuration(t.duration) : null) || e
        },
        instantiateView: function (t) {
            var e = this.getViewSpec(t), n = new e["class"](this, e.options, e.duration);
            return n.type = n.name = t, n
        },
        isValidViewType: function (t) {
            return Boolean(this.getViewSpec(t))
        }
    });
    we.calendarClass = Xe, Xe.defaults = {
        titleRangeSeparator: " — ",
    ...
    }, Xe.englishDefaults = {dayPopoverFormat: "dddd, MMMM D"}, Xe.rtlDefaults = {
        header: {
    ...
    var Ue = we.langs = {};
    we.datepickerLang = function (e, n, i) {
        var r = Ue[e] || (Ue[e] = {});
        r.isRTL = i.isRTL, r.weekNumberTitle = i.weekHeader, t.each($e, function (t, e) {
            r[t] = e(i)
    ...
    }, we.lang = function (e, i) {
        var r, s;
        r = Ue[e] || (Ue[e] = {}), i && (r = Ue[e] = n(r, i)), s = pe(e), t.each(qe, function (t, e) {
            void 0 === r[t] && (r[t] = e(s, r))
        }), Xe.defaults.lang = e
    };
    var $e = {
        buttonText: function (t) {
            return {prev: F(t.prevText), next: F(t.nextText), today: F(t.currentText)}
    ...
    we.lang("en", Xe.englishDefaults), we.sourceNormalizers = [], we.sourceFetchers = [];
    var Ke = {dataType: "json", cache: !1}, Qe = 1;
    Xe.prototype.getPeerEvents = function () {
        return this._getPeerEvents.apply(this, arguments)
    };
    var Je = Se.basic = je.extend({
        dayGrid: null,
        dayNumbersVisible: !1,
        ...
        headRowEl: null,
        initialize: function () {
            this.dayGrid = new We(this), this.coordMap = this.dayGrid.coordMap
        },
        setRange: function (t) {
            je.prototype.setRange.call(this, t), this.dayGrid.breakOnWeeks = /year|month|week/.test(this.intervalUnit), this.dayGrid.setRange(t)
        },
        computeRange: function (t) {
        ...
        updateWidth: function () {
            this.weekNumbersVisible && (this.weekNumberWidth = d(this.el.find(".fc-week-number")))
        },
    ...
    tn.duration = {months: 1}, tn.defaults = {fixedWeekCount: !0}, Se.basicWeek = {
        type: "basic",
        duration: {weeks: 1}
    }, Se.basicDay = {type: "basic", duration: {days: 1}};
    var en = 5;
    AgendaView = Se.agenda = je.extend({
        timeGrid: null,
        dayGrid: null,
        axisWidth: null,
        noScrollRowEls: null,
        ...
        initialize: function () {
            this.timeGrid = new Ze(this), this.opt("allDaySlot") ? (this.dayGrid = new We(this), this.coordMap = new Ve([this.dayGrid.coordMap, this.timeGrid.coordMap])) : this.coordMap = this.timeGrid.coordMap
        },
        setRange: function (t) {
            je.prototype.setRange.call(this, t), this.timeGrid.setRange(t), this.dayGrid && this.dayGrid.setRange(t)
        },
        render: function () {
        ...
        headIntroHtml: function () {
            var t, e;
            return this.opt("weekNumbers") ? (t = this.timeGrid.getCell(0).start, e = this.formatWeekNumber(t), '<th class="fc-axis fc-week-number ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + ">" + "<span>" + M(e) + "</span>" + "</th>") : '<th class="fc-axis ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + "></th>"
        },
        dayIntroHtml: function () {
        ...
        updateSize: function (t) {
            t && this.timeGrid.resize(), je.prototype.updateSize.call(this, t)
        },
        updateWidth: function () {
        ...
        computeInitialScrollState: function () {
            ...
            return this.timeGrid.computeTimeTop(t)
        },
        renderEvents: function (t) {
            var e, n, i = [], r = [], s = [];
        ...
        maxTime: "24:00:00",
        slotEventOverlap: !0
    }, Se.agendaWeek = {type: "agenda", duration: {weeks: 1}}, Se.agendaDay = {type: "agenda", duration: {days: 1}}
});