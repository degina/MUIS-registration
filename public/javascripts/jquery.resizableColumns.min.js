...
!function (a, b) {
    ...
    return d = function (a) {
        ...
        return c.prototype.defaults = {
            ...
            var c;
            return a(this.$table.attr("ownerDocument")).off(".rc"), this.$handleContainer.find(".rc-handle").each(function () {
                return function (b, c) {
                    var d;
                    return d = a(c), d.removeData("th"), d.off("mousedown touchstart")
                }
            }(this)), this.$handleContainer.remove(), this.$handleContainer = null, this.$table.removeData("resizableColumns"), this.$table.add(b).off(".rc"), this.$tableHeaders = null, c = this.$table, this.$table = null, c
            ...
            }(this)), h.one("mouseup.rc touchend.rc", function (a) {
                return function () {
