...
function openBlackPopup(url, width, height, onCloseCallBack, iframeId) {
    ...
    bdiv.append("<img src=\"/public/ganttChart/res/closeBig.png\" style='cursor:pointer;position:absolute;right:-40px;top:30px;'>");
...
function createBlackPage(width, height, onCloseCallBack) {
    ...
    bg.css({
        ...
        width: '100%',
        height: '100%',
        backgroundImage: "url('/public/ganttChart/res/black_70.png')"
    });
    ...
    var img = $("<img src='/public/ganttChart/res/closeBig.png' style='cursor:pointer;position:absolute;right:-40px;top:5px;' title='close'>");
    bdiv.append(img);
    img.click(function () {
        bg.trigger("close");
    });
