...
//		} else if (token=="MMM" || token=="NNN"){
            ...
            var names = (token == "EEEE" ? Date.dayNames : token == "EEE" ? Date.dayAbbreviations : Date.dayAbbreviationMini);
            for (var i = 0; i < names.length; i++) {
...
Date.prototype.format = function (format) {
    ...
    value["d"] = d;
    value["dd"] = Date.LZ(d);
    value["E"] = Date.dayAbbreviationMini[E];
    value["EE"] = Date.dayAbbreviationMini[E];
