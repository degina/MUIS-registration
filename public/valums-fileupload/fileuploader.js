...
qq.FileUploaderBasic = function (o) {
    this._options = {
        ...
        // messages
        messages: {
            typeError: "{file} -н төрөл таарахгүй байна. Энэ хавтасанд зөвхөн {extensions} файлыг хуулах боломжтой.",
            sizeError: "{file} хэмжээ хэтэрсэн файл байна, хамгийн ихдээ {sizeLimit} байх ёстой",
...
qq.FileUploader = function (o) {
    ...
    qq.extend(this._options, {
        ...
        uploadButtonText: 'Файл хуулах',
        cancelButtonText: 'Болих',
        failUploadText: 'Амжилтгүй',
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onProgress: function (id, fileName, loaded, total) {
        ...
        if (loaded != total) {
            ...
            text = percent + '% хувь ' + this._formatSize(total);
        } else {
